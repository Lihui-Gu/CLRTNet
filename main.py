...
if __name__ == '__main__':
    # python main.py configs/clrnet/clr_resnet18_port.py --finetune_from models/tusimple_r18.pth --gpus 0
    # python main.py configs/clrnet/clr_resnet18_port.py --test --gpus 0
    main()
