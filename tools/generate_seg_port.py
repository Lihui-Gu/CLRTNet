...
TRAIN_SET = ['label_data_train_noisy.json']
VAL_SET = ['label_data_valid.json']
TRAIN_VAL_SET = TRAIN_SET + VAL_SET
TEST_SET = ['label_data_test.json']
...
if __name__ == '__main__':
    # python tools/generate_seg_port.py --root data/port
