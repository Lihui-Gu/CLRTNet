...
work_dirs = "work_dirs/clr/r18_port"

timesformer= dict(type='TimeSformer',
                        dim=64,
...
total_iter = (236 // batch_size + 1) * epochs
...
dataset_path = './data/port'
dataset_type = 'Port'
test_json_file = 'data/port/label_data_test.json'
