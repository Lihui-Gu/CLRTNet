...
SPLIT_FILES = {
    'trainval':
    ['label_data_train_noisy.json', "label_data_valid.json"],
    'train': ['label_data_train_noisy.json'],
    'val': ['label_data_valid.json'],
    'test': ['label_data_test.json'],
}

@DATASETS.register_module
class Port(BaseDataset):
    ...
    def load_annotations(self):
        self.logger.info('Loading Port annotations...')
        self.data_infos = []
        max_lanes = 0
